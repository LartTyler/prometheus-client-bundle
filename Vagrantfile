...
Vagrant.configure("2") do |config|
	...
	config.vm.provision "shell", inline: <<-SHELL
		...
		apt-get install -y build-essential software-properties-common nodejs php5.6-common php5.6-cli php5.6-mysqlnd \
			php5.6-curl php5.6-zip php5.6-mbstring php5.6-xml php5.6-xdebug
